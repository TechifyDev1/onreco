...
export async function generateMetadata(
    ...
    return {
        ...
        openGraph: {
            ...
            description: post.description,
            type: "article",
            url: `https://fluxhq.vercel.app/blog/${post.slug}`,
            siteName: "Onreco",
...
function ArticleJsonLd({ post }: { post: ReturnType<typeof getPost> }) {
    ...
    const jsonLd = {
        ...
        publisher: {
            ...
            logo: {
                "@type": "ImageObject",
                url: "https://fluxhq.vercel.app/favicon.ico",
            },
        },
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": `https://fluxhq.vercel.app/blog/${post.slug}`,
        },
        image: `https://fluxhq.vercel.app${post.image || "/blog_banner_image_1.jpg"}`,
    };
    return (
        <script
            ...
            return (
                <div className="bg-glass rounded-2xl p-8 mt-8 text-center border border-primary/20">
                    ...
                    <p className="text-on-surface-variant max-w-xl mx-auto mb-6">
                        Join the waitlist to get early access to Onreco and stop
                        recording stablecoin transactions by hand.
                    </p>
                    <Link
                        href="/waitlist"
