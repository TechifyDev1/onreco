      ...
      >
        ...
        <div className="relative z-10 w-full max-w-3xl text-center">
          ...
          <p className="mx-auto max-w-2xl text-base leading-7 text-on-surface-variant md:text-lg">
            Thanks for joining the Onreco waitlist. We&apos;ll reach out as soon
            as your spot opens — and we&apos;ll make sure stablecoin bookkeeping
        ...
        <div className="relative z-10 mt-12 grid w-full max-w-3xl gap-5 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-sm leading-6 text-on-surface-variant">
              Tell your network about Onreco. Accountants, bookkeepers, and web3
              founders saving hours on stablecoin reconciliation.
            </p>
          ...
          >
            ...
            <p className="text-sm leading-6 text-on-surface-variant">
              Share Onreco with your accountant, bookkeeper, or finance lead so
              you&apos;re ready to hit the ground running when onboarding opens.
            </p>
