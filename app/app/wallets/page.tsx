...
export const metadata = {
    ...
    description:
        'Connect and monitor wallets across Tron, Solana, Base, and other supported networks.',
};
            ...
            <header className="flex items-center gap-2 mb-4">
                ...
                <div>
                    ...
                    <p className="text-xs text-on-surface-variant">
                        Onreco monitors activity on these chains. New chains roll out as demand
                        grows.
                    </p>
                </div>
            </header>
