...
export default function Sidebar() {
    ...
    return (
        <aside
            className="hidden lg:flex w-64 shrink-0 flex-col border-r border-outline-variant/10 bg-surface-container-lowest fixed inset-y-0 left-0 z-40"
        ...
        >
            ...
            <div className="px-3 py-4 border-t border-outline-variant/10">
                ...
                <div className="mt-3 px-3 text-[10px] font-semibold tracking-[0.08em] uppercase text-outline">
                    v0.1.0 &middot; Onreco
                </div>
            </div>
        </aside>
    );
