        ...
        <>
            <div className="relative" ref={ref}>
                <button
                    ...
                    onClick={() => setOpen((v) => !v)}
                    className={
                        "flex items-center gap-3 pl-2 pr-3 py-1.5 rounded-lg hover:bg-surface-container transition-colors " +
                ...
                >
                    ...
                    <ChevronDown
                        className={
                            "hidden md:block w-4 h-4 text-on-surface-variant transition-transform " +
                            (open ? "rotate-180" : "")
                        }
                        strokeWidth={1.75}
                    />
                ...
                {open && (
                    ...
                    >
                        ...
                        {/* Footer */}
                        <div className="px-4 py-2 border-t border-outline-variant/10 text-[10px] font-semibold tracking-[0.08em] uppercase text-outline">
                            Acme Corp · v0.1.0
                        </div>
                    </div>
                )}
